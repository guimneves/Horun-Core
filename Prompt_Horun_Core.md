...
6. **Mural**: responder um aviso (thread de respostas) e marcar/mencionar colaboradores específicos.
7. **Agenda**: arrastar os blocos de horário pra reagendar (hoje só cria/cancela por formulário).
