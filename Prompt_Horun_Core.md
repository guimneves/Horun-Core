...
6. **DNS interno** — resolver o aviso de certificado self-signed no navegador (seção 4/`Prompt_Fase2.md`).
7. Ideias de mais funcionalidades pro Core (notificações, busca de verdade, etc.) — ver conversa/registro de decisões para a lista completa levantada em 2026-09-10.
